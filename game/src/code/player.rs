...
pub fn player_movment_system(time: Res<Delta>, input: Res<Inputs>, mut query: Query<&mut FreeCamera>) {
...
pub fn move_player_light(mut query: Query<(&FreeCamera, &mut PointLight)>) {
